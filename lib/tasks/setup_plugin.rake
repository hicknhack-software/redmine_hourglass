...
desc "Install redmine chronos plugin"
namespace :redmine do
  namespace :plugins do
    namespace :redmine_chronos do
      ...
      task :install do
        Rake::Task["redmine:plugins:redmine_chronos:convert:coffeescript"].invoke
        Rake::Task["redmine:plugins:redmine_chronos:convert:sass"].invoke
      end
